 ...
 */
class CRM_Funds_Form_Component extends CRM_Core_Form
{
    protected $_id;
    ...
    {
        return 'civicrm_o8_fund_component';
    }
    ...
    public function preProcess()
    {
        ...
        CRM_Utils_System::setTitle('Add Component');
        if ($this->_id) {
            CRM_Utils_System::setTitle('Edit Component');
            $entities = civicrm_api4('FundComponent', 'get',
                ['where' => [
                    ['id', '=', $this->_id]],
                    'limit' => 1
                ]
            ...
            $session->replaceUserContext(CRM_Utils_System::url('civicrm/fund/component',
...
//                        'contact_id.search_name',
            ...
            CRM_Utils_System::setTitle('Delete Component');
            $this->addButtons([
    ...
    {
        if ($this->_action == CRM_Core_Action::DELETE) {
            civicrm_api4('FundComponent', 'delete', ['where' => [['id', '=', $this->_id]]]);
            CRM_Core_Session::setStatus(E::ts('Removed Component'), E::ts('Component'), 'success');
        } else {
...
//            CRM_Funds_BAO_Fund::create($values);
            $result = civicrm_api4('FundComponent', $action, ['values' => $params]);
            CRM_Core_Session::setStatus(ts('Your Component has been saved.'), ts('Saved'), 'success');
        }
        parent::postProcess();
    }
