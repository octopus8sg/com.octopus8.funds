CRM.$(function ($) {
    ...
    $("a.add-transaction").click(function (event) {
        ...
        var $el = CRM.loadForm(href, {
            ...
            var hm_tab = $('.selector-org-transactions');
    ...
    $(document).ready(function () {
        ...
        $('.selector-org-transactions').on('click', 'tr', function () {
            $(this).toggleClass('row_selected columnheader');
        });

        var transactions_tab = $('.selector-org-transactions');
        ...
        $('a.select-all-transactions').click(function (event) {
            event.preventDefault();
            $('.selector-org-transactions tr').toggleClass('row_selected columnheader');

        });
        //End Reset Table
        $('.transaction-org-filter :input').change(function () {
            new_transactions_table.draw();
        });
