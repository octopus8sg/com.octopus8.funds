 ...
 */
class CRM_Funds_Upgrader_Base {

  /**
   * @var CRM_Funds_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Funds_Upgrader(
        'com.octopus8.funds',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Funds_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Funds_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
